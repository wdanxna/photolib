...
//        }
        ...
        /*----*/
        MAGridCameraView* gridView = [[MAGridCameraView alloc] init];
        [gridView setFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height - kCameraToolBarHeight)];
...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(transitionToMAImagePickerControllerAdjustViewController) name:kImageCapturedSuccessfully object:nil];
    ...
    else
    {
        ...
        //I custom that, reframe the picker view to landscape size
//        _invokeCamera.view.frame = self.view.frame;
...
//    UIImage* compressed = [UIImage imageWithData:UIImageJPEGRepresentation([[self captureManager] stillImage], 0.1f)];
